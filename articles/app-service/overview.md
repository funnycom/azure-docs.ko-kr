...
App Service를 사용하면 Azure 계산 리소스에 대한 비용을 지불하게 됩니다. 사용한 컴퓨팅 리소스는 앱을 실행하는 _App Service 플랜_에 따라 결정됩니다. 자세한 내용은 [Azure App Service 계획 개요](overview-hosting-plans.md)를 참조하세요.
